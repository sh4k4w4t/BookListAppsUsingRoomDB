...
public class EditBookFragment extends Fragment {
        ...
        binding.updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bookPrice.isEmpty()||bookTitle.isEmpty()){
                    ...
                    Book book= new Book(bookDataController.getCurrentBook().getId(),bookTitle,bookPrice,bookDataController.getCurrentBook().getWriterId());
                    UpdateBookInformation(book);
                    Toast.makeText(getActivity(), ""+book.getId(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void UpdateBookInformation(Book book) {
        bookRepository.UpdateBook(requireContext(),book);
//        LibraryDatabase libraryDatabase= LibraryDatabase.getInstance(requireContext());
